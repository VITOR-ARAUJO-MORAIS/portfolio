...
export default function Section4(){
    ...
    return <section id='section4'>
        ...
        <div id="icons">
            ...
            <img alt="Typescript" src="https://devicons.railway.app/i/javascript.svg" />
            </div>
            <div className="grid-item">
            <img alt="Java" src="https://devicons.railway.app/i/php.svg" />
            </div>
            <div className="grid-item">
            <img alt="nodejsIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original-wordmark.svg" />
            </div>
            <div className="grid-item">
            <img alt="Bootstrap" src="https://devicons.railway.app/i/bootstrap.svg" />
            </div>
            <div className="grid-item">
            ...
            <div className="grid-item">
            <img alt="htmlIcon" src="https://devicons.railway.app/i/mysql.svg" />        
            </div>
            <div className="grid-item">
            <img alt="JQuery"  src="https://devicons.railway.app/i/jquery.svg" />
            </div>
